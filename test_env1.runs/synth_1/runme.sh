...
HD_PWD='D:/vivado/test_env1/test_env1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proba1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proba1.tcl
