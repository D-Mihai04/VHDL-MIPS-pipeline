...
HD_PWD='D:/vivado/test_env1/test_env1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proba1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proba1.tcl -notrace
